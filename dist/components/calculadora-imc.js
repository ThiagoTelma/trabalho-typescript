...
async function calcularIMC() {
    ...
    const pesoStr = await (0, readline_1.perguntar)("Digite o peso em kg: ");
    const peso = parseFloat(pesoStr);
    const alturaStr = await (0, readline_1.perguntar)("Digite a altura (ex: 1.75 ou 175): ");
